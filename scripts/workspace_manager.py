"""Workspace manager — git clone, branch, push, and PR operations for workflow repos."""
...
if TYPE_CHECKING:
    from workflow_loader import RepoConfig
...
# ---------------------------------------------------------------------------
# Init workspace — clone repos + create feature branches
# ---------------------------------------------------------------------------

def init_workspace(repos: list["RepoConfig"], issue_number: int) -> None:
    """Clone repos and create/checkout feature branches for the given issue.
...
# ---------------------------------------------------------------------------
# Push workspace — stage, commit, push, and open PR
# ---------------------------------------------------------------------------
...
def push_workspace(
    ...
    for rc in repos:
        ...
        try:
            ...
            _ensure_pr(rc, repo_dir, branch, issue_number, issue_repo)
        except Exception as e:
